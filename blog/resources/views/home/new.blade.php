...
<article class="blogs">
    <h1 class="t_nav">
        <span>您当前的位置：<a href="{{url( '/' )}}">首页</a>&nbsp;&gt;&nbsp;<a href="{{url( 'list/'.$field->cate_id ) }}">{{$field->cate_name}}</a>&nbsp;&gt;&nbsp;</span><a href="{{url( '/' )}}" class="n1">网站首页</a><a href="{{url( 'list/'.$field->cate_id )}}" class="n2">{{$field->cate_name}}</a></h1>
