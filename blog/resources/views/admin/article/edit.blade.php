    ...
    <form action="{{url( 'admin/article/'.$field->id )}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th></th>
                <td>
                    <img id="art_thumb_v" alt="" src="/{{$field->art_thumb}}" style="width:350px;height:70px;">
                </td>
            </tr>
            <tr>
                <th>文章标签：</th>
                <td>
                    <input type="text" size="50" name="art_tag" value="{{$field->art_tag}}">
                </td>
            </tr>
            ...
            <tr>
                <th>描述：</th>
                <td>
                    <textarea name="art_description" value="{{$field->art_description}}"></textarea>
                </td>
            </tr>
            <tr>
                <th>编辑：</th>
                <td>
                    <input type="text" size="20" name="art_editor" value="{{$field->art_editor}}"></input>
                </td>
            </tr>
            <tr>
                <th>文章内容：</th>
